...
This markdown uses hourly temperature data to look for seasonal and annual trends. Temperature is in Fahrenheit.
...
temp_table <- annual_trends_all %>%
  kbl(caption = "Decadal Trends of Temperature (°F) from 1941-2022") %>%
