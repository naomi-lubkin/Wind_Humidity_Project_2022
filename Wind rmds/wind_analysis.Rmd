...
date: '2022-06-01'
---
Most of this rmd is covered with 2022 updates in wind_1941_2022.Rmd. This rmd contains a seasonal wind analysis that we didn't end up going any farther with, as well as wind plots/sens slopes for both 1935-2021 and 1981-2021 wind data broken down by month. 
...
monthly_avg_decomp <- monthly_avg %>%
  mutate (year = year(date), 
          month = month(date)) %>%
  dplyr::select(year, month, monthly_avg_spd)
