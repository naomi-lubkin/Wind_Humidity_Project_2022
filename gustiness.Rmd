...
---
Gustiness Analysis
Not really using anymore, but wanted to save it somewhere in case it comes up again.The idea was to look at the peak gust for the day as compared to the average for the day, in order to determine how gusty a particular day was. Daily gusts probably aren't fine enough scale to get a good sense of gustiness though, and we don't have hourly gust data.  
